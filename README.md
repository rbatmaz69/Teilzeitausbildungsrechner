...
```
cd existing_repo
git remote add origin https://git.it.hs-heilbronn.de/it/courses/seb/lab/ws25/group-04.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.it.hs-heilbronn.de/it/courses/seb/lab/ws25/group-04/-/settings/integrations)
