...
def _validiere_verkuerzungsgruende(data: Mapping[str, Any]) -> None:
    allowed_keys = {"abitur", "realschule", "alter_ueber_21", "familien_pflegeverantwortung", "vorkenntnisse_monate"}
    ...
    for key in {"abitur", "realschule", "alter_ueber_21", "familien_pflegeverantwortung"}:
...
def _normalisiere_verkuerzungsgruende(data: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "familien_pflegeverantwortung": bool(data.get("familien_pflegeverantwortung", False)),
